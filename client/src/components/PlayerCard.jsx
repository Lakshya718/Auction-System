    ...
    <div className="player-card bg-white/10 backdrop-blur-lg rounded-2xl shadow-lg overflow-hidden border border-gray-200/20 transition-all duration-300 hover:shadow-2xl hover:scale-105">
      <div className="flex flex-col md:flex-row items-center p-6 gap-6">
        ...
        <div className="relative flex-shrink-0">
          ...
          />
          {player.playerRole && (
            <span className="absolute bottom-2 right-0 bg-purple-600 text-white text-xs font-bold px-2 py-1 rounded-full capitalize">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          {currentTeam && (
            <p className="text-gray-300">
              Highest Bidder:{' '}
              <span className="font-semibold text-white">{currentTeam}</span>
            </p>
          )}
        </div>
