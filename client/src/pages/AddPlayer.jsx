      ...
      >
        ...
        <div className="text-center">
          <button
            type="submit"
            disabled={loading}
            className="mt-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-2.5 rounded-md shadow-md hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mx-auto text-sm"
          >
            {loading ? (
              <LoadingSpinner />
            ) : (
