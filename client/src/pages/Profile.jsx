    ...
    <div className="flex min-h-screen bg-gray-900 text-white">
      ...
      <main className="flex-grow p-8 transition-all duration-300">
        ...
        <div className="max-w-6xl mx-auto">
          {/* Profile Header */}
          <div className="relative bg-gradient-to-r from-purple-700 to-indigo-800 rounded-xl shadow-lg p-6 mb-8 overflow-hidden">
            <img
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-4">
              <div className="relative w-28 h-28 rounded-full border-2 border-white shadow-md flex-shrink-0">
                <img
              ...
              <div className="text-center md:text-left mt-2 md:mt-0">
                ...
                {user && (
                  <button
                    ...
                    className="mt-2 flex items-center justify-center gap-1 px-4 py-2 bg-white text-purple-800 rounded-full hover:bg-gray-200 transition-colors shadow-sm text-sm font-medium"
                  >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-gray-800 rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center text-sm">
                  <FaEnvelope className="text-purple-400 mr-3 text-base" />
                  <p>
            ...
            {team && (
              <div className="bg-gray-800 rounded-xl shadow-lg p-6 flex flex-col items-center text-center">
                <h3 className="text-xl font-bold text-white mb-4 border-b border-gray-700 pb-3 w-full">
                  Team Information
                </h3>
                <img
                  src={team.teamLogo || 'https://via.placeholder.com/100'}
                  alt="Team Logo"
                  className="w-24 h-24 rounded-full object-cover mb-4 border-2 border-purple-500 shadow-md"
                />
                ...
                <button className="mt-4 flex items-center gap-1 px-4 py-2 bg-purple-600 text-white rounded-full hover:bg-purple-700 transition-colors shadow-sm text-sm font-medium">
                  <FaUsers className="text-sm" /> View Team
                </button>
              </div>
            )}
            ...
            <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <ul className="space-y-2 text-gray-300 text-sm">
                  <li>
                    <span className="text-purple-400 mr-1">•</span> Joined
                    "Fantasy League 2025"
                  </li>
                  <li>
                    <span className="text-purple-400 mr-1">•</span> Bid on
                    "Player X" in Auction #123
                  </li>
                  <li>
                    <span className="text-purple-400 mr-1">•</span> Updated
                    profile picture
                  </li>
                  <li>
                    <span className="text-purple-400 mr-1">•</span> Created new
                    auction "Summer Draft"
                  </li>
                </ul>
              </div>
              <div className="bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">Auctions Joined</p>
                  </div>
                  <div>
                    <p className="text-purple-400 text-2xl font-bold">8</p>
                    <p className="text-gray-300 text-sm">Players Owned</p>
                  </div>
                  <div>
                    <p className="text-purple-400 text-2xl font-bold">$5,000</p>
                    <p className="text-gray-300 text-sm">Total Spend</p>
                  </div>
                  <div>
                    <p className="text-purple-400 text-2xl font-bold">3</p>
                    <p className="text-gray-300 text-sm">Teams Managed</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 text-center">
            <button
              ...
              className="flex items-center justify-center mx-auto gap-2 px-6 py-2 bg-red-600 rounded-full hover:bg-red-700 transition-colors shadow-md text-sm font-medium"
            >
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-32 h-32 rounded-full mb-4">
              ...
              <label
                ...
                className="absolute -bottom-2 -right-2 bg-purple-600 p-3 rounded-full cursor-pointer hover:bg-purple-700 transition-colors z-10"
              >
                <FaCamera />
                <input
                  id="profilePicInput"
