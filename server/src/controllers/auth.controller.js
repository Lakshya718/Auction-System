...
export const register = async (req, res) => {
  try {
    const { name, email, password, role, teamName, sport } = req.body;
    ...
    try {
      if (role === "team_owner") {
        ...
        let imageUrl =
          "https://t3.ftcdn.net/jpg/05/13/39/96/360_F_513399651_7X6aDPItRkVK4RtrysnGF8A88Gyfes3T.jpg";
        if (req.file) {
        ...
        const team = new Team({
          ...
          logo: imageUrl,
          owner: user._id,
          sport: sport || "cricket", // Default to cricket if no sport is provided
        });
        await team.save();
      }
